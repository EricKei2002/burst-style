    ...
    <div className="relative aspect-3/4 w-full overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 font-mono text-xs sm:text-sm text-zinc-300 flex flex-col justify-center gap-3">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="inline-flex items-center rounded bg-[#2496ed]/10 px-1.5 py-0.5 text-[#2496ed]">
            Docker
          </span>
          <span className="inline-flex items-center rounded bg-[#5865F2]/10 px-1.5 py-0.5 text-[#5865F2]">
            Discord BOT
          </span>
        </div>
      </div>
...
function TimelineVideoCard({
  ...
  return (
    <div
      ref={cardRef}
      className="relative aspect-3/4 w-full overflow-hidden rounded-lg border border-zinc-800 bg-black/50"
    >
      {!isActive ? (
        <>
          <Image
...
const timeline: TimelineItem[] = [
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2002.0 Initial Commit: プロジェクト「Eric
          Kei」が和歌山県にてローンチされました。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-fuchsia-400 font-mono text-xs shrink-0 mt-1">
              [Init]
            </span>
            <span>新規ユーザー「Eric Kei」を作成。</span>
          </li>
          <li className="flex gap-2">
            <span className="text-blue-400 font-mono text-xs shrink-0 mt-1">
              [System]
            </span>
            <span>コアカーネル（生命）が正常に起動。</span>
          </li>
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
              [Inherit]
            </span>
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          和歌山県にて出生。エンジニアである父の影響を強く受けて育ちました。
        </p>
        <p>
  ...
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2013.0 Early Access:
          プログラミングの世界へ初めてログイン。創造性の初期パラメータを設定。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          プログラミングとの初めての出会いは、ビジュアルプログラミング言語「Scratch」でした。
        </p>
        <p>
  ...
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2015.0 Feature Update:
          友人からの招待コードにより、本格的なコーディング環境へ移行。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-blue-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          友人の影響を受け、より本格的な開発言語であるC#の学習を開始しました。
        </p>
        <p>
          Visual
          Studioを用いたWindowsフォームアプリケーションの開発を通じて、変数、条件分岐、ループ処理といったプログラミングの基礎概念に加え、オブジェクト指向の初歩を独学で習得しました。
  ...
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2019.0 Hardware Upgrade:
          ソフトウェアだけでなく、実行環境（ハードウェア）への最適化プロセスを開始。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          ソフトウェアへの関心に加え、ハードウェア領域へも興味を広げました。
        </p>
        <p>
    ...
    images: ["/images/hardware/parts.jpg"],
    videos: ["/videos/pc-build.mp4"],
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2019.1 Global Connect:
          シリコンバレーサーバーへのアクセスに成功。エンジニアとしての視座をアップデート。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-fuchsia-400 font-mono text-xs shrink-0 mt-1">
            ...
            <span>
              グローバルテック本社（Google, Meta, Intel）へのアクセス確立。
            </span>
          </li>
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          高校時代、中学時代にC#を教えてくれた友人がGoogleに入社したため、彼を訪ねて米国のシリコンバレーを訪問しました。Google,
          Meta, Intelといった世界的テック企業も見学しました。
        </p>
        <p>
  ...
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2020.0 Security Patch:
          パンデミックによる接続エラー（留学中止）発生に伴い、デジタル空間へ強制ルーティング。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-red-400 font-mono text-xs shrink-0 mt-1">
              [Fix]
            </span>
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          パンデミックの影響で留学計画が変更となる中、オンラインコミュニティ（Discord）での活動に活路を見出しました。
        </p>
        <p>
    ...
    images: ["/images/pandemic/gaming_setup.jpg", "/images/pandemic/tokyo.jpg"],
  },
  {
    year: "2022(Summer)",
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2022.1 Localization Update:
          バーチャルな友情データを物理レイヤー（現実）へ同期。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          オンラインで親交を深めた友人を訪ねるため、単身で北米（カナダ・アメリカ）へ渡航しました。
        </p>
        <p>
    ...
    images: ["/images/pandemic/us_flag.jpg"],
    videos: ["/videos/north_america.mp4"],
  },
  {
    year: "2022 〜 2025",
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2022.2 Physics Engine Update:
          物理演算（スノーボード）の処理性能を極限まで向上。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-blue-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          白馬やニセコといったリゾート地での住み込み業務に従事しました。現地は外国人の来訪者が多く、業務や日常生活において英語でのコミュニケーションが必須の国際色豊かな環境でした。
        </p>
        <p>
    ...
    images: ["/images/resort/hakuba.jpg", "/images/resort/niseko.jpg"],
    videos: ["/videos/snowboard.mp4"],
  },
  {
    year: "2025 ",
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2025.0 Major Refactor:
          エンジニアリングスキルをモダンスタックへ完全移行。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-fuchsia-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          Webエンジニアとしてのキャリアを志し、モダンなWeb開発技術（ TypeScript,
          React, Next.js）を集中的に学習しました。
        </p>
        <p>
  ...
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2026.0 Infrastructure Expansion:
          ローカル環境にLinuxサーバーをデプロイ。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          フロントエンド開発に加え、バックエンドやインフラ領域への理解を深めるため、自宅サーバーの構築・運用を行っています。
        </p>
        <p>
          Raspberry
          Piを用いたLinuxサーバーのセットアップ、SSH接続設定、Dockerコンテナによるアプリケーション（Discord
          Bot等）の運用を通じて、
  ...
  },
  {
    ...
    description: (
      <div className="space-y-4">
        <p>
          v2026.1 Stable Release:
          本番環境（キャリア）へのデプロイに成功。個人サイトは引き続き実験フィールドとして稼働。
        </p>
        <p>
          現在は、フロントエンドエンジニアとして会社に所属しながら、プライベートでは個人開発や
          AWS SAA の資格取得に向けた勉強を続けています。
        </p>
        <ul className="list-none space-y-2 pl-2">
          <li className="flex gap-2">
            <span className="text-fuchsia-400 font-mono text-xs shrink-0 mt-1">
          ...
          <li className="flex gap-2">
            ...
            <span>
              独学で育てたスタックと、個人での検証ループは継続チャネルとして維持。
            </span>
          </li>
          <li className="flex gap-2">
            <span className="text-green-400 font-mono text-xs shrink-0 mt-1">
          ...
          <li className="flex gap-2">
            ...
            <span>
              仕様により「好奇心」がメモリを消費しますが、本番とサイドプロジェクトの両方で返済中です。
            </span>
          </li>
        </ul>
    ...
    professionalDescription: (
      <div className="space-y-4 text-zinc-300">
        <p>
          フロントエンドエンジニアとして就業し、プロダクト開発に携わっています。
        </p>
        <p>
          現在は会社に所属しながら、プライベートでは個人開発や AWS SAA（AWS
          ...
          」（Next.js /
          Supabase）を自作し、実際の受験対策として毎日使っています。
        </p>
        <p>
          React / TypeScript
          を中心とした実装に加え、学習で培った適応力と英語コミュニケーションを活かし、チームに貢献することを重視しています。
          業務外ではインフラや AI
          周りの実験も続け、視野を広げながら成長していきたいと考えています。
        </p>
      </div>
    ),
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <header className="about-header mb-16 max-w-2xl">
          <div
            className={`flex items-center gap-2 mb-4 transition-colors duration-300 ${isProfessional ? "text-blue-400" : "text-fuchsia-400"}`}
          >
          ...
          <div className="about-card space-y-12 lg:sticky lg:top-32 lg:self-start">
            ...
            <div className="flex justify-center lg:justify-start">
              <ProfileCard
                ...
                growthImages={["/profile-mid.jpg", "/profile-new.jpg"]}
              />
            </div>
          </div>
            ...
            {timeline.map((item, index) => (
              <div key={index} className="relative pl-12 sm:pl-16">
                ...
                <div className="absolute left-[13px] top-2 flex h-6 w-6 items-center justify-center rounded-full bg-[#0a0a0a] ring-1 ring-zinc-700 sm:left-[29px]">
                  <div
                    className={`h-1.5 w-1.5 rounded-full transition-all duration-300 ${isProfessional ? "bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.8)]" : "bg-fuchsia-500 shadow-[0_0_8px_rgba(236,72,153,0.8)]"}`}
                  />
                </div>
                ...
                <div className="group rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 transition hover:border-zinc-700 hover:bg-zinc-900/50">
                  <div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
                    <h3
                      className={`text-lg font-semibold text-zinc-200 transition-colors duration-300 ${isProfessional ? "group-hover:text-blue-400" : "group-hover:text-fuchsia-400"}`}
                    >
                      {item.title}
                    </h3>
                      ...
                      {item.images?.map((src, i) => (
                        ...
                        >
                          <Image
                            ...
                            className="object-contain transition-transform duration-500 hover:scale-105"
                            sizes={
                              src.includes("terminal") || src.includes("hakuba")
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {item.tags.map((t) => (
                      <span
                        key={t}
                        className="rounded-md border border-zinc-800 bg-black/50 px-2 py-1 text-[10px] font-medium text-zinc-400 uppercase tracking-wide"
                      >
                        {t}
                      </span>
                    ))}
