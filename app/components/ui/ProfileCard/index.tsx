            ...
            <div className={styles.content}>
              ...
              <div className={styles.details}>
                ...
                <div className="mt-4 flex gap-2">
                  <span className="bg-zinc-800/50 px-2 py-1 rounded text-xs text-yellow-300 border border-yellow-500/20">
                    JavaScript
                  </span>
                  <span className="bg-zinc-800/50 px-2 py-1 rounded text-xs text-blue-300 border border-blue-500/20">
                    TypeScript
                  </span>
                  <span className="bg-zinc-800/50 px-2 py-1 rounded text-xs text-green-300 border border-green-500/20">
                    Python
                  </span>
                </div>
