...
export default function AboutSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full overflow-hidden bg-[#0a0a0a] py-24 sm:py-32">
      {/* Background Grid */}
          ...
          <div className="about-card space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-emerald-400">
                ...
                <span className="font-mono text-xs tracking-wider uppercase">01. Who I am</span>
              </div>
              ...
              <div key={index} className="relative pl-12 sm:pl-16">
                ...
                <div className="group rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 transition hover:border-zinc-700 hover:bg-zinc-900/50">
                  <div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
                    <h3 className="text-lg font-semibold text-zinc-200 group-hover:text-emerald-400 transition-colors">
